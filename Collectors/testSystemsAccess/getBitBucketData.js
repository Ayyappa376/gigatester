...
const repo = 'deduper'; //'lcache_salt' 'acache_salt' 'helper_scripts' 'ffmpeg-fingerprint' 'exoplayer' 'dyna_qa' 'jeremy_diagrams' 'dynapack';
...
httpRequest.httpRequest('GET', baseURL + getAllCommitsOfRepo , undefined, auth, { Accept: 'application/json' })
