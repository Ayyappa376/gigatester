...
export type ASSESMENT_HISTORY_ACTIONS = FETCH_ASSESMENT_HISTORY_FAIL
    | FETCH_ASSESMENT_HISTORY_SUCCESS
    | FETCH_ASSESMENT_HISTORY_START
...
export function fetchAssessmentHistory() {
    return (dispatch: Function, getState: Function) => {
        ...
        Http.get<IAssessmentHistoryResponse>({
            ...
            const result: IAssessmentHistoryStoreFormat = mapAssessmentHistory(response)
...
function fetchDataSuccess(data: IAssessmentHistoryStoreFormat):
...
function fetchDataFail(message: object): AssesmentActions<ILoadAssessmentHistoryRequest> {
    return {
