import { IAssesmentAnswersMap, IAssesmentPostRequest } from './answers';
import { IAssesmentQuestionRequest } from './questions';
import { IAssesmentSummaryRequest } from './summary';
...
export interface IAssesment {
  assesmentSummary: IAssesmentSummaryRequest;
  assesmentQuestion: IAssesmentQuestionRequest;
  markedAnswers: IAssesmentAnswersMap;
  assesmentAnswers: IAssesmentPostRequest;
