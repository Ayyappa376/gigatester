...
import {
  ILimitedProductDetails, IFeedbackComments,
  ...
  feedbackBarChartOptions, ILastEvalKey, IFetchRecursiveData, getPieChartOptions
} from './common';
              ...
              <Grid container>
                <Grid item sm={9}>
                  {attachmentType == 'image' ?
                    <Image aspectRatio={4 / 3} onClick={handleImageClicked} width='90%' style={{
                      display: 'block',
                      marginLeft: 'auto',
                      marginRight: 'auto',
                      marginTop: 20,
      ...
      <Container>
        ...
        {searchInitiated ? <div>
          <RenderTable key="renderTable2" tableData={searchedData} urls={urlArray} isBugReport={isBugReport} viewAttachmentClicked={handleViewAttachmentClicked} fetchMore={fetchMore}
            ...
            setCurrentDisable={setCurrentDisable} category={category} severity={severity} rating={rating} keys={key}
          />
        </div>
          :
          <div>
