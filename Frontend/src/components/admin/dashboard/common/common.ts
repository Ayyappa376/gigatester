...
export const hexColors = ['#A3D4FE', '#5CB3FE', '#0E88F1', '#036ECA', '#025296', '#013969', '#01294C', '#060E77', '#393D79', '#4F5167'];
...
function convertColorHexToRgba(hex: string) {
  ...
  return `rgba(${rgbVals.r.toString(10)}, ${rgbVals.g.toString(10)}, ${rgbVals.b.toString(10)}, 1)`;
}
